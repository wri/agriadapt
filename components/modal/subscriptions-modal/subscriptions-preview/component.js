...
class SubscriptionsPreview extends PureComponent {
  ...
  render() {
    const { loading, data, handleCancel, handleSubscribe, activeDataset } =
      this.props;
    ...
    return (
      <div className="c-subscriptions-preview">
        ...
        <div className="preview-buttons">
          <button className="c-btn -primary preview" onClick={handleSubscribe}>
            Done
          </button>
          <button
          ...
          <button className="c-btn -secondary preview" onClick={handleCancel}>
            Cancel
          </button>
        </div>
      </div>
