const inputs = {
  land_suitability: {
    ...
    widgetIds: ['2a1aab23-1c36-4a17-b5e0-b63a68531c63'],
  ...
  seedlings: {
    ...
    widgetIds: ['e9ef2704-04b7-4ab1-adce-57d0a73317d9'],
  },
};
const production = {
  production_volume: {
    ...
    widgetIds: ['8cf03ba0-a517-4a43-b5b4-e677ccc6099c'], 
  ...
  pests_and_disease: {
    ...
    widgetIds: [], //TODO: Missing WidgetID (N/A)
  },
};
const trade = {
  policies_and_price: {
