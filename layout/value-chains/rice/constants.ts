const inputs = {
  land_suitability: {
    ...
    widgetIds: ['043440a2-b3fd-493e-93a9-362eac5637c7'], // TODO: Additional Stacked Bar Visual
  },
  seedlings: {
    ...
    widgetIds: ['9529e2a9-112c-4c77-b893-5b5a4d983be7'],
  },
  //   fertilizer: {
...
const production = {
  ...
  production: {
    ...
    widgetIds: ['d95ad48d-e14e-42cd-a5fb-1d8054c258d9'],
  },
  production_volume: {
