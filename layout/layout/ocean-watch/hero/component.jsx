...
export default function OceanWatchHero({ className }) {
  ...
  return (
    <section
      className={classnames("l-page-header", { [className]: !!className })}
    >
      ...
      >
        <ShareModal
          ...
          analytics={{
            facebook: () =>
              logEvent("Share", "Share dashboard: Ocean Watch", "Facebook"),
            twitter: () =>
              logEvent("Share", "Share dashboard: Ocean Watch", "Twitter"),
            email: () =>
              logEvent("Share", "Share dashboard: Ocean Watch", "Email"),
            copy: (type) =>
              logEvent("Share", "Share dashboard: Ocean Watch", `Copy ${type}`),
          }}
        />
      </Modal>
    </section>
