    ...
    <Modal isOpen={isOpen} onRequestClose={closePopup}>
      <div className="c-layer-info-modal">
        <div className="layer-info-content">
          ...
          <p>
            Track natural disasters, monitor the changing environment, and
            observe human events with this selection of Resource Watch's most
            timely data. All data visualized on the globe are frequently updated
            by the data provider, from multiple times a day to monthly.
            <br />
